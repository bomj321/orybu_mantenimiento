...
<form method="POST" enctype="multipart/form-data">
                      ...
                      <h1>Company Information </h1></center>
									<div class="form-group">
									</br>
						...
						<div class="form-group">
										<label>Top List Limit</label>
		
										
					        <input  type="text" name="limitTopList" tabindex="1" class="form-control"   value="<?php echo $limitTopList ?>">
							
										
						</div>
						<div class="form-group">
										<label>Show Case Limit</label>
		
										
					        <input  type="text" name="limitShowCase" tabindex="1" class="form-control"   value="<?php echo $limitShowCase ?>">
					...
					<option value="Zimbabwe">Zimbabwe</option>
									...
									<center><h1>Described your Company </h1>
									</center>
			...
			<center><button type="submit" name="btn_save" class="btn btn-default" style="border-style:solid;border-width:1px;border-color:gray;color:#066;background:#ccc"><i class="fa fa-refresh" >
       &nbsp; Update Profile</i>
        </button>
           
       
		<a href="manageSupplier.php" class="btn btn-warning"><i class="fa fa-times"></i> CANCEL</a>
       </input>
           </br>
		     </br>  </br>
