...
if($nr >0)
{
  ?>		
									...
									<div class="widget-body no-padding table-responsive">
										...
										<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
											<thead>			                
												<tr>
													...
													<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i> Price</th>
													<th data-hide="phone"><i class="fa fa-fw fa-phone text-muted hidden-md hidden-sm hidden-xs"></i> Description</th>
													<th>Category</th>
													<th>Product Type</th>
													<th data-hide="phone,tablet"><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Supplier Name</th>
												
													<th data-hide="phone,tablet"><i class="fa fa-fw fa-map-email txt-color-blue hidden-md hidden-sm hidden-xs"></i> Product Image</th>
											...
											?>
												...
												<td>
												<?php $string =$row['image'];
												$cl = explode(',', $string);
												?><a href="../images/<?php echo $cl[0]; ?>" ><img style="height:50px;width:50px;"src="../images/<?php echo $cl[0]; ?>"</a></td>
												<td><?php  $productstatus =$row['productstatus'];
													
													?>
														<input type="hidden" name="productstatus" value="<?php echo $productstatus ?>" />
													<?php 
													if($productstatus =='0')
													{
												  ...
												  <a   class="btn btn-xs btn-primary" href="checkProduct.php?productstatus=<?php echo $row['productstatus'];?> & pid=<?php echo $row['pid'] ?> & email=<?php echo $row['email'] ?>">Accept</a>
													...
													?>
												  <a   class="btn btn-xs btn-danger" href="checkProduct.php?productstatus=<?php echo $row['productstatus'];?> & pid=<?php echo $row['pid'] ?> & email=<?php echo $row['email'] ?>">Reject</a>
										...
										<td> 		<a    href="javascript:contact_Id(<?php echo $row['pid'];?>)"><i class="fa fa-trash-o fa-lw"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a    href="productDetail.php?pid=<?php echo $row['pid'];?>"><i class="fa fa-eye"></i>
										<?php  $productaction =$row['productaction'];
												  ...
												  <a   class="btn btn-xs btn-danger" href="checkProductActive.php?productaction=<?php echo $row['productaction'];?> & pid=<?php echo $row['pid'] ?>">Show Case OFF</a>
													...
													?>
												  <a   class="btn btn-xs btn-primary" href="checkProductActive.php?productaction=<?php echo $row['productaction'];?> & pid=<?php echo $row['pid'] ?>">Show Case ON</a>
