...
?>
	<div id="datos-chat">
		...
		<?php if (!empty($nueva_oferta)) {				
			?> 
		<span><a class="text-danger" href="mycartArryBy.php?pid=<?php echo $pid; ?>&precio_nuevo=<?php echo $nueva_oferta; ?>&cantidad_nuevo=<?php echo $cantidad_oferta; ?>">New Offer for <?php echo $nueva_oferta .'$';?> and <?php echo $cantidad_oferta;?> item(s)</a></span>
		<?php
			}
			?>
		<span style="color: black; float: right;"><?php echo formatearFecha($fila['fecha']); ?></span>
