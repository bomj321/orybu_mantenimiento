<?php
    ...
    switch ($charType) {
        case "y":
            ...
            WHERE year(n.visited_at) = '$año' GROUP BY n.id_catid order by n.id_catid";
        break;
        case "m":
            $description = "Mes";
            $año = htmlspecialchars($_POST['año']);
            ...
            GROUP BY n.id_catid order by n.id_catid";      
        break;
        case "d":
            $description = "Día";
            $año = htmlspecialchars($_POST['año']);
            ...
            $sql="Select n.id_catid AS categoria, (n.visited_at) AS periodo, 
            COUNT(n.id_catid) AS visitas FROM chart_category_subcatego_admin n
            WHERE YEAR(n.visited_at) = '$año' AND 
            MONTH(n.visited_at) = '$mes' AND DAY(n.visited_at) BETWEEN '$min'
            AND '$max' GROUP BY n.id_catid order by n.id_catid";
        break;
    }            
