...
if (isset($userStatus)) {
	$message =
		...
		<html>
            ...
            <img style='width:12.5em; height:6.25em;' src='https://www.orybu.com/img/oryLogo.png'>
             ...
             <p>Thank you for registering, please confirm your email by <a href='https://www.orybu.com/spanish/b2b/emailconfirm.php?email=$email&code=$confirmcode&userStatus=1'> clicking here</a>. 
              </p>

              <p>Gracias por registrarte, porfavor confirma tu email haciendo <a href='https://www.orybu.com/spanish/b2b/emailconfirm.php?email=$email&code=$confirmcode&userStatus=1'> click aqui</a>.  
              </p>
            </body>
        </html>		
	...
	<html>
            ...
            <img style='width:12.5em; height:6.25em' src='https://www.orybu.com/img/oryLogo.png'>
             ...
             <p>
                Thank you for registering, please confirm your email by<a href='https://www.orybu.com/spanish/b2b/emailconfirm.php?email=$email&code=$confirmcode'>clicking here</a>.
              </p>
